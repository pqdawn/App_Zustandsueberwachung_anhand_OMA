%% Callback für Button zum Importieren der Linien (Modi "Modalanalyse" und "Zusammenführung")
...
function line_import_button_pushed(cache, node_table, line_table, lamp, status)
    ...
    try
        ...
        update_status(status, lamp, '>> Linien importiert', 'erfolg');
