%% Callback für Auswählen der Pole (SSI-DATA, abgeleitete Messdaten)
% Author: Qiao Dawn Puah
% Datum letzter Bearbeitung: 30.06.2026

function choose_pole_button_pushed_data_diff(app, fig)
    ...
    try
        ...
        if ~isempty(app.fig.UserData.cache.modal.data_selected_pole_diff)
            ...
            switch choice
                ...
                case 'Nein'
                    ...
                    [app.fig.UserData.cache.modal.data_all_pole_diff.is_chosen] = deal(false);
                    ...
                    plot_stab_diag(stab_graph, app.fig.UserData.cache.modal.data_all_pole_diff, all_poles_tick, ...
