%% Callback für Auswählen der Pole (SSI-COV, originale Messdaten)
% Author: Qiao Dawn Puah
% Datum letzter Bearbeitung: 30.06.2026

function choose_pole_button_pushed_cov_original(app, fig)
    ...
    try
        ...
        if ~isempty(app.fig.UserData.cache.modal.cov_selected_pole)
            ...
            switch choice
                ...
                case 'Nein'
                    ...
                    [app.fig.UserData.cache.modal.cov_all_pole.is_chosen] = deal(false);
                    ...
                    plot_stab_diag(stab_graph, app.fig.UserData.cache.modal.cov_all_pole, all_poles_tick, ...
