%% Callback für Button zur Übertragung der Auswahlen (SSI-COV)
% Author: Qiao Dawn Puah
% Datum letzter Bearbeitung: 30.06.2026

function transfer_choice_button_pushed_cov(app, fig)
    ...
    try
        ...
        eigenfreq_chosen_diff = [app.fig.UserData.cache.modal.cov_selected_pole_diff.freq_mean];
